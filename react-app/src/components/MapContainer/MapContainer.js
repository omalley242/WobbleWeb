    ...
    const MapItems = data.map((item, index) => (
        <div key={index} className='Map-Item' style={{position: 'absolute', left: item.X_Pos, bottom: item.Y_Pos}}>
            ...
            <svg class='node' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M3.6001 15H14.1501" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6.55127 4.93823L9.8114 14.9719" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
